...
if ($method === 'GET') {
    ...
    $sql = 'SELECT id, name, academic_year, start_date, end_date, default_tuition, is_current, closed_at, closed_by_user_id, is_archived, archived_at, created_at, updated_at
            FROM academic_terms';
